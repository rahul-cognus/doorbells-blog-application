            ...
            <div class="container">
                ...
                <div class="row pt-5">
                    ...
                    <div class="col-sm-6 col-lg-3 mb-4">
                        ...
                        <div class="row g-2">
                            <div class="col">
                                <a href="#"><img class="w-100" src="/images/app-store.svg" alt="app-store" /></a>
                            </div>
                            <div class="col">
                                <a href="#"><img class="w-100" src="/images/google-play.svg" alt="google-play" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-dark-overlay-3 mt-5">
                <div class="container">
                    <div class="row align-items-center justify-content-md-between py-4">
                        <div class="col-md-6">
                            {/* Copyright */}
                            <div class="text-center text-md-start text-primary-hover text-body-secondary">©2023 <a href="https://www.webestica.com/" class="text-reset btn-link" target="_blank">Webestica</a>. All rights reserved
                            </div>
                        </div>
