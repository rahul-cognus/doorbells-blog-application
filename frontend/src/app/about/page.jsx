                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <div className="card bg-dark-overlay-4 overflow-hidden card-bg-scale h-400 text-center" style={{
                                backgroundImage: "url(/images/blog/16by9/09.jpg)",
                                    ...
                                    <div className="w-100 my-auto">
                                        ...
                                        <nav className="d-flex justify-content-center" aria-label="breadcrumb">
                                            <ol className="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                                                <li className="breadcrumb-item"><a href="index-2.html"><i className="bi bi-house me-1"></i> Home</a></li>
                        ...
                        <div className="col-xl-9 mx-auto">
                            ...
                            <div className="row g-4">
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="text-center">
                                        {/* Avatar img */}
                                        <div className="avatar avatar-xxl mb-2">
                                            <img className="avatar-img rounded-circle" src="/images/avatar/14.jpg" alt="avatar" />
                                        </div>
                                ...
                                <div className="col-sm-6 col-lg-3">
                                    <div className="text-center">
                                        {/* Avatar img */}
                                        <div className="avatar avatar-xxl mb-2">
                                            <img className="avatar-img rounded-circle" src="/images/avatar/10.jpg" alt="avatar" />
                                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 col-lg-4 mb-4">
                                    <img className="rounded" src="/images/blog/3by2/04.jpg" alt="Card image" />
                                ...
                                {/* Service item*/}
                                <div className="col-md-6 col-lg-4 mb-4">
                                    <img className="rounded" src="/images/blog/3by2/01.jpg" alt="Card image" />
                                ...
                                {/* Service item*/}
                                <div className="col-md-6 col-lg-4 mb-4">
                                    <img className="rounded" src="/images/blog/3by2/03.jpg" alt="Card image" />
